...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        'infinite-scroll-medium-ltr': 'infinite-scroll-ltr 30s linear infinite',
        'infinite-scroll-slow-ltr': 'infinite-scroll-ltr 40s linear infinite',
        'infinite-scroll-fast-ltr': 'infinite-scroll-ltr 20s linear infinite',
        'infinite-scroll-medium-rtl': 'infinite-scroll-rtl 30s linear infinite',
        'infinite-scroll-slow-rtl': 'infinite-scroll-rtl 40s linear infinite',
        'infinite-scroll-fast-rtl': 'infinite-scroll-rtl 20s linear infinite',
      },
      keyframes: {
        'infinite-scroll-ltr': {
